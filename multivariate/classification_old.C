...
int classification_old( TString myMethodList = "" )
{
  TString output_name = "TMVA_old.root";
  TString factory_name = "classification_old";
  ...
  // The explicit loading of the shared libTMVA is done in TMVAlogon.C, defined in .rootrc
   ...
   TString fname_signal = "$SW_WORK_DIR/multivariate_analysis/data_0nu_mm.root";
   ...
   TString fname_background_2nu = "$SW_WORK_DIR/multivariate_analysis/data_2nu.root";
   TString fname_background_tl208 = "$SW_WORK_DIR/multivariate_analysis/data_tl208.root";
   TString fname_background_bi214 = "$SW_WORK_DIR/multivariate_analysis/data_bi214.root";
   ...
   //   factory->BookMethod( TMVA::Types::kBDT, "BDT",
   //                        "!H:!V:NTrees=1000:MinNodeSize=0.01%:MaxDepth=6:BoostType=AdaBoost:SeparationType=GiniIndex:nCuts=400" );
   ...
   //  if (Use["BDT"])  // Adaptive Boost
   // factory->BookMethod( TMVA::Types::kBDT, "BDT",
   //                      "!H:!V:NTrees=800:MinNodeSize=0.5%:MaxDepth=2:BoostType=AdaBoost:SeparationType=CrossEntropy:nCuts=400" );
...
int main( int argc, char** argv )
{
   ...
   return classification_old(methodList);
}
