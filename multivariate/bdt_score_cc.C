...
TFile * f_0nu = TFile::Open("./bdt_scores/cc/0nu_rhc/individual_channel/0nu_Ecut_confC_D.root");
TFile * f_2nu = TFile::Open("./bdt_scores/cc/0nu_rhc/individual_channel/2nu_full_Ecut_confC_D.root");
TFile * f_tl208 = TFile::Open("./bdt_scores/cc/0nu_rhc/individual_channel/tl208_Ecut_confC_D.root");
TFile * f_bi214 = TFile::Open("./bdt_scores/cc/0nu_rhc/individual_channel/bi214_Ecut_confC_D.root");
TFile * f_radon = TFile::Open("./bdt_scores/cc/0nu_rhc/individual_channel/radon_Ecut_confC_D.root");
  ...
  if(counts)
    TFile * f_output= new TFile("./bdt_scores/cc/0nu_rhc/bdt_scores_counts_confC_D.root","RECREATE");
  else
    TFile * f_output= new TFile("./bdt_scores/cc/0nu_rhc/bdt_scores_confC_D.root","RECREATE");
