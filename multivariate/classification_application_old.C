...
void classification_application_old( TString myMethodList = "" )
{
   ...
   TString dir    = "weights/";
   TString prefix = "classification_best";
   ...
   TString fname = "$SW_WORK_DIR/multivariate_analysis/data_bi214.root";
   ...
   std::cout << "--- classification_application    : Using input file: " << input->GetName() << std::endl;
   ...
   TString file_target = "old_bi214.root";
   ...
   std::cout << "==> classification_application is done!" << std::endl << std::endl;
}
...
int main( int argc, char** argv )
{
   ...
   classification_application_old(methodList);
   return 0;
}
